    ...
    const linkData = {
        whatsapp: {
            daerah: [
                ...
                { name: 'DKI Jakarta', url: 'https://chat.whatsapp.com/KiGAxXOwUey4CTgRVdn72D' },
                { name: 'Jawa Barat', url: '⁠https://chat.whatsapp.com/He3IaZUItLF4ZNAkssRM4R' },
                { name: 'Jawa Tengah', url: 'https://chat.whatsapp.com/BJWAII9eeo9BYqFIQSB0fo' },
                { name: 'Jawa Timur', url: 'https://chat.whatsapp.com/FXFjiVgxOxVKz0xBPaJUM4' },
                { name: 'DI Yogyakarta', url: 'https://chat.whatsapp.com/Gm8HOulyZUC9fwI4yOrUBG' },
                { name: 'Sumatera Utara', url: 'https://chat.whatsapp.com/B7kDbXXsTl8KbpPs6Jwmoy' },
                ...
                { name: 'Kepulauan Riau', url: 'https://chat.whatsapp.com/EmOdoW4TOrl4oU46jAJf63    ' },
                ...
                { name: 'Nusa Tenggara Barat', url: 'https://chat.whatsapp.com/BYCk58M4rq2EtNCTNbb4JN' },
            ...
            instansi: [
                { name: 'informasi Formasi', url: 'https://whatsapp.com/channel/0029Val5EQ8KWEKqdW8FGa1l' },
                { name: 'Kemenkumham', url: 'https://chat.whatsapp.com/KjuuYz0KZYWE77lMq7Jt5Q' },
                ...
                { name: 'KLHK', url: 'https://chat.whatsapp.com/Gn8Fj3suxqaAqgILQH4nWO' },
                { name: 'Kementerian Pertahanan', url: 'https://chat.whatsapp.com/GnyhyVZUm3t7Y1npKN3Yzs' },
                { name: 'Kejaksaan Agung', url: 'https://chat.whatsapp.com/JPtDBROV56BH8yjBBqY5QO' },
                { name: 'Mahkamah Agung Republik Indonesia (MA)', url: 'https://chat.whatsapp.com/HqkjpKmfOPH8FY2VEcXtoY' },
                { name: 'BKKBN', url: 'https://chat.whatsapp.com/K88KkRp2h9OKrovyhRHeOy' },
                { name: 'Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi (Kemendikbud)', url: 'https://chat.whatsapp.com/GkHDTSuCvyiLPh9kCrBwcp' },
                { name: 'Kementerian Kesehatan (Kemenkes)', url: 'https://chat.whatsapp.com/JPMKUyIgAoyAtSrtAIG0jH' },
                { name: 'Kementerian Agama RI (Kemenag)', url: 'https://chat.whatsapp.com/GzwPzox6uhyH0sT6Et0Mo1' },
                // ... (sisanya tetap sama)
            ]
        },
        telegram: {
